...
const headPhoneData = [
  {
    ...
    subtitle:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci odio dicta pariatur laborum dolorum distinctio commodi accusantium nihil quidem harum quibusdam voluptatem ipsum, assumenda perspiciatis, illo quisquam nesciunt rem doloribus.",
    price: "$199",
    modal: "Modal Brown",
    bgColor: "#8b5958",
  },
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <motion.button
                    ...
                    className="px-4 py-2 inline-block font-normal rounded-[15px] transition-all duration-300 hover:brightness-90"
                  >
                    Buy and Listen
                  </motion.button>
                </UpdateFollower>
